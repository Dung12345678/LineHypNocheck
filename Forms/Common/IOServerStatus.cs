...
namespace InControls.Common
{
	...
	public unsafe struct IOServerStatus : IVikiSerialzer
	{
		...
		private static extern void CopyMemory(ref IOServerStatus dest, IntPtr src, int size_t);

		[System.Runtime.InteropServices.DllImport("kernel32.dll")]
		private static extern void CopyMemory(IntPtr dest, ref IOServerStatus src, int size_t);

		[System.Runtime.InteropServices.DllImport("kernel32.dll")]
		private static extern void CopyMemory(IntPtr dest, IntPtr src, int size_t);
		#endregion
